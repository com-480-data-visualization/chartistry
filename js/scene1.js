...
function drawMap() {
  ...
  const colorScale = d3.scaleSequential()
    ...
    .interpolator(d3.interpolateRgbBasis(['#1c1010', '#5c0c0c', '#b71c1c', '#ff4500', '#ff1a1a'])); 
  ...
  document.querySelectorAll('.tog').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (leg) {
        ...
        leg.querySelector('.leg-grad').style.background = 'linear-gradient(to right, #1c1010, #5c0c0c, #b71c1c, #ff4500, #ff1a1a)';
      }
      syncMapMetricDefinition();
    });
  });
